...
import drBack from "@/assets/drBack.jpeg";
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      review:
        "Best mattress I've ever owned! My back pain is completely gone and I sleep so much better now.",
    },
    {
      name: "Rajesh Kumar",
      location: "Delhi",
      rating: 5,
      review:
        "Excellent quality and fast delivery. The customer service team was very helpful throughout.",
    },
    {
      name: "Anjali Patel",
      location: "Bangalore",
      rating: 5,
      review:
        "My whole family loves our new mattresses. Great value for money and superb comfort!",
    },
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-200 max-w-2xl mx-auto leading-relaxed">
            Experience the perfect blend of comfort and support with our premium
            mattresses, designed specifically for Indian homes and families.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">
                India’s Top-Rated Ortho Mattress Brand
              </h2>
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                With our Motion Isolation Technology, movements on one side of
                the bed won’t disturb the other. This is made possible by the
                use of natural latex and rubberized coir — giving you an
                undisturbed and pain-free sleep. The mattress ensures proper
                shoulder and lumbar support, which is vital for those with
                chronic back pain.
              </p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-4xl font-bold mb-6">
                Discover the Best Orthopedic Mattresses
              </h2>
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                Experience comfort with a purpose — Dr. Back Orthopedic
                Mattresses are designed to deliver therapeutic benefits that
                enhance your everyday life. These mattresses offer a perfect
                balance of firmness and comfort, ensuring your spine remains
                properly aligned while providing plush support that invites
                deep, restful sleep.
              </p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center space-x-3">
                ...
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full"></div>
                  <span>Motion isolation for undisturbed sleep</span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full"></div>
                  <span>Doctor-recommended support</span>
                </li>
              </ul>
              <Link to="/products">
                <Button variant="default" size="lg">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="h-5 w-5 text-accent-light fill-current"
                      />
                    ))}
                  </div>
      ...
      {/* <section className="py-20 bg-gradient-to-r from-primary to-accent text-primary-foreground">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold mb-6">Ready for Better Sleep?</h2>
          <p className="text-xl mb-8 text-primary-foreground/90">
            Join thousands of Indians who have transformed their sleep with
            SleepWell mattresses. Start your 100-night trial today!
          </p>
